                ...
                <form action="#">
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" type="text" placeholder="000.000.000-00" name="txtCPF" id="id_cpf">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <label for="id_mail">Email:</label>
                            <input class="form-control" type="email" placeholder="mail@mail.com" name="txtMail" id="id_mail">
                        </div>
                        <div class="col">
